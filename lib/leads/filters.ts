...
export const leadFilterSchema = z.object({
  ...
  status: z.enum(leadStatuses).optional(), leadType: z.enum(["NO_WEBSITE","OUTDATED_WEBSITE"]).optional(), filtered: z.enum(["yes"]).optional(), minScore: z.coerce.number().int().min(0).max(100).optional(), issue: z.string().max(60).optional(),
