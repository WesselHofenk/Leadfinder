...
describe("databasevriendelijke generatiepolling", () => {
  it("pollt actieve tabs niet vaker dan iedere vijf seconden", () => {
  ...
  it("vertraagt verborgen tabs en netwerkfouten", () => {
    ...
    expect(generationPollingDelay(false, 3)).toBe(40_000);
    expect(generationPollingDelay(true, 3)).toBe(60_000);
  });
