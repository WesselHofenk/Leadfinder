...
export const metadata: Metadata = { title: { default: "Leadfinder Sitora", template: "%s · Leadfinder Sitora" }, description: "Gecontroleerde bedrijfsleads uit Nederland en België." };
